...
export const testPhoneNumber = (number?: string): PhoneNumber =>
  PhoneNumber.create({ number: number || '+61400800900' }).getValue();
...
export const testUnitNumber = (override?: number): UnitNumber => UnitNumber.create(override || 30).getValue();
